  ...
  const handleAdding = async () => {
    ...
    try {
      ...
      await axiosClient.post("/shop", {
        ...
        // inn is optional in the schema but blank fails validation — omit it
        // when empty instead of sending "" and 400'ing the whole create.
        ...(shopForm.inn ? { inn: shopForm.inn } : {}),
        image: imageFilename,
