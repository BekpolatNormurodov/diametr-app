...
const HTTP_MESSAGES: Record<string, { uz: string; ru: string }> = {
  ...
  'order is already finished': { uz: 'Buyurtma allaqachon bajarilgan', ru: 'Заказ уже выполнен' },
  'order is already canceled': { uz: 'Buyurtma allaqachon bekor qilingan', ru: 'Заказ уже отменён' },
  'order is not finished': { uz: 'Buyurtma hali bajarilmagan', ru: 'Заказ ещё не выполнен' },
