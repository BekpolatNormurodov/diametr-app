                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          ...cats.map<Widget>((cat) => _FilterChip(
                                label: ((context.locale.languageCode == 'ru'
                                            ? cat['name_ru']
                                            : cat['name_uz']) ??
                                        cat['name'] ??
                                        '')
                    ...
                    onTap: () => Navigator.pushNamed(
                      ...
                      arguments: {
                        'name': ((context.locale.languageCode == 'ru'
                                ? displayed[index]['name_ru']
                                : displayed[index]['name_uz']) ??
                            displayed[index]['name']),
...
class _ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String name = ((lang == 'ru' ? product['name_ru'] : product['name_uz']) ??
            product['name'])
        ?.toString()
        .trim() ??
        '';
