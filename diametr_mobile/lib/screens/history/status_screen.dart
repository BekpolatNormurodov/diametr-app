                ...
                children: [
                  ClipRRect(
                    ...
                    child: SizedBox(
                      width: 58.w,
                      height: 58.w,
                      child: e["shop_product"]?["product_item"]?["product"]?["image"] != null
                          ? CachedNetworkImage(
                              fit: BoxFit.cover,
                              memCacheWidth: 240,
                              imageUrl: Endpoints.img('products',
                                  e["shop_product"]["product_item"]["product"]["image"]),
                              placeholder: (context, url) => Shimmer.fromColors(
                                baseColor:
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          '${e["shop_product"]?["product_item"]?["product"]?[context.locale.languageCode == 'ru' ? 'name_ru' : 'name_uz'] ?? e["shop_product"]?["product_item"]?["product"]?["name"] ?? ''}',
                          maxLines: 2,
